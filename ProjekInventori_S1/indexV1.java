                            ...
                            case 2:
                                ...
                                if (hapus != -1) {
                                    ...
                                    for (int i = hapus; i < namaBrg.length - 1; i++) {
                                        namaBrg[i-1] = namaBrg[i];
                                        tipeBrg[i-1] = tipeBrg[i];
                                        prdDate[i-1] = prdDate[i];
                                        expDate[i-1] = expDate[i];
                                        supplier[i-1] = supplier[i];
                                        konSupp[i-1] = konSupp[i];
                                        alamatSupp[i-1] = alamatSupp[i];
                                        harga[i-1] = harga[i];
                                        stokBrg[i-1] = stokBrg[i];
                                    }
